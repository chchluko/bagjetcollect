<x-app-layout>
    ...
    <section class="my-24">
        <h1 class="mb-6 text-3xl text-center text-gray-600">ÚLTIMOS EXPEDIENTES</h1>
        <p class="mb-6 text-center text-gray-500 test-sm">
            Los ultimos expedientes que se han creado en el portal
        </p>
