    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <!--div>
                ...
                <x-jet-input class="block w-full mt-1" type="text" name="username" :value="old('username')" required autofocus />
            </div-->

            <div>
                <x-jet-label for="identity" value="{{ __('Username/Email') }}" />
                <x-jet-input class="block w-full mt-1" type="text" name="identity" :value="old('email')" required autofocus />
            </div>
