    ...
    <article class="card mt-4" x-data="{open:false}">
        <div class="card-body">
            ...
            <div x-show="open">
                ...
                <div class="my-2">
                    <button type="button" class="btn btn-primary text-sm" wire:click='edit({{ $item }})'>
                        Editar
                    </button>
                    <button type="submit" class="btn btn-danger text-sm" wire:click='destroy({{ $item }})'>
                        Eliminar
                    </button>
                </div>
        ...
        <article class="card" x-show="open">
            <div class="card-body">
                ...
                <div class="flex justify-end">
                    <button class="btn btn-danger text-sm" x-on:click="open = false">Cancelar</button>
                    <button class="btn btn-primary ml-2 text-sm" wire:click='store'>Agregar</button>
                </div>
            </div>
        </article>
    </div>
