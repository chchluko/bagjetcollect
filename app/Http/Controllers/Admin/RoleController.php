...
class RoleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.roles.index')->with('info', 'Role creado Satisfactoriamente');
    }
    ...
    {
        $role->delete();
        return redirect()->route('admin.roles.index')->with('info', 'Role eliminado Satisfactoriamente');
    }
}
